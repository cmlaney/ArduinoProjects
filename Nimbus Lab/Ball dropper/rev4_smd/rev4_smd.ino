...
#define DRIVEMOTORLIMIT 7
#define DRIVEMOTORCONTROLPIN 37
#define DRIVEMOTORFORWARDCONTROLPIN 10
#define DRIVEMOTORREVERSECONTROLPIN 11
#define DRIVEMOTORTRIEN 35
...
void setup() {
  ...
  digitalWrite(DRIVEMOTORCONTROLPIN, HIGH);
  ...
  pinMode(DRIVEMOTORTRIEN, OUTPUT);
  digitalWrite(DRIVEMOTORTRIEN, HIGH);
...
void loop() {
  ...
  if(digitalRead(DRIVEMOTORLIMIT)) {
    digitalWrite(LED1, HIGH);
  } else {
    digitalWrite(LED1, LOW);
  }
